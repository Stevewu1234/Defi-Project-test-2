...
import "@openzeppelin/contract/utils/SignatureChecker.sol";
import "@openzeppelin/contract/utils/Address.sol";
import "@openzeppelin/contract/utils/Strings.sol";
import "@openzeppelin/contract/interfaces/IERC1271.sol";
import "./DragonMarket/DragonRoleUpgradeable.sol";


contract MigrationSignature {
    ...
    ) internal view onlyMetaOperator {
